...
async function parse_single_server(server, options, stats) {
    ...
    // Check if we already have a record with the same last_wipe
    ...
    // console.log('Current last wipe:', rust_last_wipe);
    // console.log('Existing Records:', existing_record);
    ...
    if (existing_record && existing_record.length > 0) {
        ...
        // console.log('Existing last wipe:', existingLastWipe);
        // console.log('New last wipe:', newLastWipe);
